...
<template>
    <div class="page">
        ...
        <div class="title">
            <h3>Modificacion de Auto</h3>
            <hr>
        </div>
        <div class="formulario">
            <div class="form-titles">
                <div class="col-6 first-opcion">
                    <p>PASO 1</p>
                    <hr :class="{ active: formularioActivo1 }">
                </div>

                <div class="col-6 third-opcion">
                    <p>PASO 2</p>
            ...
            <form @submit.prevent="AltaAutoSumbit">
                ...
                <div class="opciones-buttons">
                    <div v-if="formularioActivo1">
                        <button class="anterior-button" @click="inicio">ANTERIOR</button>
